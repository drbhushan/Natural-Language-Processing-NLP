# -*- coding: utf-8 -*-
"""
Created on Wed Aug 28 23:40:10 2019
...
doc = nlp(u'Narendra Damodardas Modi is an Indian politician serving as the 14th and current Prime Minister of India since 2014')
for token in doc:
...
# pre-processing text - lematization
doc = nlp(u'I have studied in various universities')
sentence = []
for w in doc:
